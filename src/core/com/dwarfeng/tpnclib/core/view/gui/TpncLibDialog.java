 ...
 * @since 0.0.1-alpha
 */
public abstract class TpncLibDialog extends JDialog {

	private static final long serialVersionUID = 2467076958093824237L;
	 ...
	 *            国际化接口。
	 */
	public TpncLibDialog(GuiManager guiManager, I18nHandler i18nHandler) {
		super((Window) null);
	 ...
	 * @param modalityType
	 */
	public TpncLibDialog(GuiManager guiManager, I18nHandler i18nHandler, Window owner) {
		super(owner);
