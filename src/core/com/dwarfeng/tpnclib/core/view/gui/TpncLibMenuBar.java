 ...
 * @since 0.0.1-alpha
 */
public abstract class TpncLibMenuBar extends JMenuBar {

	private static final long serialVersionUID = 3755104041093202450L;
	 ...
	 *            国际化接口。
	 */
	public TpncLibMenuBar(GuiManager guiManager, I18nHandler i18nHandler) {
